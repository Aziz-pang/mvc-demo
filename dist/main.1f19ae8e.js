...
(0, _jquery.default)('#number').text(number || 100);

var reset = function reset(n) {
  localStorage.setItem('number', n);
  (0, _jquery.default)('#number').text(n);
};

(0, _jquery.default)('#btnItems').on('click', function (e) {
  var btn = e.target.id;
  var n = parseInt((0, _jquery.default)('#number').text());
...
var $tabBar = (0, _jquery.default)('#app2 > .header');
var $content = (0, _jquery.default)('#app2 .content');
var localKey = 'app2.index';
var index = localStorage.getItem(localKey);
$tabBar.on('click', 'p', function (e) {
  var $tab = (0, _jquery.default)(e.currentTarget);
  var tabIndex = (0, _jquery.default)(e.currentTarget).index();
  localStorage.setItem(localKey, tabIndex);
  $tab.addClass('selected').siblings().removeClass("selected");
  $content.children().eq(tabIndex).addClass('active').siblings().removeClass("active");
}); //trigger()自动触发事件
...
var $change = (0, _jquery.default)('#app3 > .block');
...
require("./app4.js");
},{"./global.css":"global.css","./app1.js":"app1.js","./app2.js":"app2.js","./app3.js":"app3.js","./app4.js":"app4.js"}],"../../../../.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
